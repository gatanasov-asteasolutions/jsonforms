...
var actions$5 = [
    ...
    },
    {
        ...
        apply: function (props) {
            return __assign(__assign({}, props), { uischema: uischema$F });
        },
    },
];
registerExamples([
...
var translate$2 = function (key, defaultMessage) {
    var _a;
    return (_a = lodash.get(translations$2, key)) !== null && _a !== void 0 ? _a : defaultMessage;
};
registerExamples([
    {
        name: 'array-i18n',
...
var actions$3 = [
    ...
    },
    {
        label: 'Disable Sorting',
        apply: function (props) {
            return __assign(__assign({}, props), { uischema: uischema$x });
        },
    },
];
registerExamples([
...
var schema$t = schema$u;
var uischema$t = __assign(__assign({}, uischema$u), { options: {
        variant: 'stepper',
    } });
var data$v = data$w;
registerExamples([
...
var schema$s = schema$u;
var uischema$s = __assign(__assign({}, uischema$u), { options: {
        variant: 'stepper',
        showNavButtons: true,
    } });
var data$u = data$w;
...
var combinedSchema = __assign(__assign({}, extendedSchema), { properties: __assign(__assign({}, schema$r.properties), extendedSchema.properties) });
...
var combinedData = __assign(__assign({}, data$t), extendedData);
registerExamples([
    {
...
var schema$p = undefined;
var uischema$p = undefined;
var data$r = data$D;
registerExamples([
    {
        name: 'generate',
...
var schema$o = personCoreSchema;
var uischema$o = undefined;
var data$q = data$D;
registerExamples([
    {
        name: 'generate-ui',
...
var onChange$2 = function (dispatch) {
    return function (extensionState) {
        return function (_a) {
            ...
            var localiseFunc = localize[extensionState.locale.split('-')[0]];
            localiseFunc(errors);
...
var data$6 = { oneOfMultiEnum: ['foo'], multiEnum: ['bar'] };
registerExamples([
    {
        name: 'multi-enum',
